...
import { buildRespostasDetalhadas, buildInstrucaoTransmissao, isDiagnosticoCdpValid, sanitizarCdpPorTransmissao } from './cdp-validation';
...
export default async function handler(req, res) {
    ...
    const body = (req.body ?? {});
    const respostasDetalhadas = body.respostasDetalhadas ??
...
`.trim();
    try {
        ...
        const tipoTransmissao = typeof body.veiculo?.['tipoTransmissao'] === 'string'
