...
import { TriageStepPath } from '@core/constants/triage-steps';
...
export type { DiagnosticoCdp, PodeDirigir, UrgenciaGeral } from '@core/models/cdp.model';
export type { TriageSnapshot } from '@core/models/triage.model';
export type { Veiculo, VeiculoOrigem } from '@core/models/veiculo.model';
